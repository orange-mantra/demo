...
class Save extends \Orangemantra\Demo\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('orangemantra_demo/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('orangemantra_demo/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('orangemantra_demo/*/new');
                }
                return;
            } catch (\Exception $e) {
